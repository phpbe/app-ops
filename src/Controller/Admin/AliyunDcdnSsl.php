...
/**
 * @BeMenuGroup("阿里云证书")
 * @BePermissionGroup("阿里云证书")
 */
class AliyunDcdnSsl extends Auth
{

    /**
     * 阿里云CDN证书
     *
     * @BeMenu("全站加速证书", icon="el-icon-document-copy", ordering="1.2")
     * @BePermission("全站加速证书", ordering="1.2")
     */
